  ...
  return (
    ...
    <IndividualProductBase>
      ...
      <section className="description">
        <h2>Descrição</h2>
        <p>O Tesla Model X redefine o conceito de veículo elétrico de luxo, oferecendo uma experiência de condução emocionante, espaçosa e ecologicamente correta. Combinando a elegância de um SUV com tecnologia avançada e um design aerodinâmico impressionante, o Model X eleva a excelência automotiva a um novo patamar.</p>
      </section>
